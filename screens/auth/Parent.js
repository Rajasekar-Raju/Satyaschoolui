...
export default class Parent extends React.Component {
  state = {lang: null, firstName: null, lastName: null, babyName: null, babyDob: null, phoneNo: null, address: null, password: null, retypePassword: null, email: null};
  ...
  render() {
    const {firstName, lastName, babyName, babyDob, phoneNo, address, lang, password, retypePassword, email} = this.state;
      ...
      <View style={styles.container}>
        <ScrollView style={styles.scrollContainer}>
          ...
          <View style={styles.itemContainer}>
            ...
            <Input name="babyName" placeholder="" type="default" image={TextImg} value={babyName} onChange={this.handleChange} editable={true} />
          </View>
          <View style={styles.itemContainer}>
            <Text style={styles.labelText}>{language[lang].babyDob}</Text>
            <Input name="babyDob" placeholder="" type="default" image={Calendar} value={babyDob} onChange={this.handleChange} editable={true} />
          </View>
          <View style={styles.itemContainer}>
